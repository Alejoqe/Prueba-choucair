...
Feature: User Creates an account
  ...
  Scenario Outline: User can create an account
    ...
    Examples:
      ...
      | Alejandro | quiroz  | alejoquiroze123@gmail.com | Choucair. | Choucair | Cr87a#32-81 | Cr87a#32-81 | Medellin | 33206      | Hiring    | 7748954   | 3005647895  | TestAutomation | MY ACCOUNT     |
  ...
  Scenario Outline: user can log in account
    ...
    Examples:
      ...
      | alejoquiroze123@gmail.com   | Choucair. | MY ACCOUNT  |
